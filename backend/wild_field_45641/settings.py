"""
Django settings for wild_field_45641 project.
...
ROOT_URLCONF = 'wild_field_45641.urls'
...
WSGI_APPLICATION = 'wild_field_45641.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wild_field_45641 API",
    "DESCRIPTION": "API documentation for wild_field_45641 App",
    "VERSION": "v1",
}
